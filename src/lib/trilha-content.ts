...
// americanos (NQ/ES) via mesas proprietárias (prop firms). Editável livremente.
//
...
export const TRILHA: TrilhaModule[] = [
    ...
    lessons: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: "warn", text: "Em mesas proprietárias, o drawdown não é só matemático — é uma **regra rígida**. Atingiu o limite, a conta morre. Vamos detalhar isso no Módulo 5." },
          { type: "tip", text: "Registre seu saldo e pico no Journal pra sempre saber sua margem real até o limite de drawdown da sua firm." },
  ...
  // ───────────────────────────── MÓDULO 5 ─────────────────────────────
  {
    id: 5,
    slug: "prop-firms",
    title: "Mesas Proprietárias (Prop Firms)",
    ...
    lessons: [
      {
        ...
        blocks: [
          ...
          { type: "list", items: [
            ...
            "Recebe uma conta financiada com capital da firma.",
            "Os lucros que você gera são divididos (você fica com a maior parte).",
          ] },
          { type: "p", text: "Existem várias mesas proprietárias de futuros no mercado, cada uma com suas próprias regras de tamanho de conta, drawdown e payout — mas os conceitos abaixo valem pra praticamente todas elas. Confira sempre o regulamento oficial da sua." },
      ...
      },
      {
        ...
        duration: "6 min de leitura",
        blocks: [
          { type: "p", text: "A avaliação é uma conta de tamanho fixo onde você precisa atingir uma meta de lucro respeitando o drawdown. A maioria das firms não impõe prazo apertado — o foco é não quebrar as regras." },
          { type: "h", text: "Os pilares da avaliação" },
          { type: "list", items: [
            "**Meta de lucro**: o valor que você precisa alcançar (varia por tamanho de conta e por firm).",
            "**Trailing drawdown**: o limite de perda que 'persegue' seu pico (próxima aula — é o que mais reprova).",
            "**Dias mínimos de operação**: algumas firms exigem um número mínimo de dias operados.",
          ] },
          { type: "tip", text: "Use o **Planner** do MeuTrade pra registrar a meta e o limite de perda da sua avaliação antes de cada sessão — e o Journal pra acompanhar se está dentro das regras dia a dia." },
          { type: "key", text: "Avaliação = atingir a meta de lucro sem violar o trailing drawdown, cumprindo os requisitos da firm. Não quebrar regras importa mais que correr." },
        ],
      },
      {
        id: "5-3",
        ...
        duration: "7 min de leitura",
        blocks: [
          { type: "p", text: "Se existe UM motivo pelo qual a maioria reprova numa avaliação, é não entender o trailing drawdown. Preste atenção dobrada aqui." },
          { type: "h", text: "Como funciona" },
          { type: "p", text: "Na maioria das prop firms, o drawdown é um 'piso' que fica te seguindo. Ele sobe junto com o **pico de saldo** da sua conta, mas nunca desce. Exemplo: numa conta com drawdown de US$ 2.500, o piso começa US$ 2.500 abaixo do saldo inicial." },
          { type: "p", text: "Conforme você lucra e o saldo faz novo pico, o piso sobe junto (mantendo a distância). Em várias firms ele considera o **lucro não realizado** (o pico intradiário), então pode subir até com posição aberta — confira como a sua firm calcula isso." },
          ...
          { type: "tip", text: "Registre seu saldo e pico no Journal pra sempre saber a distância real até o seu limite de drawdown." },
      ...
      },
      {
        ...
        duration: "6 min de leitura",
        blocks: [
          { type: "p", text: "Além do drawdown, muitas prop firms têm uma **regra de consistência**: nenhum único dia pode representar uma fatia grande demais do seu lucro total (o percentual varia por firm, geralmente entre 20% e 40%). É pra provar que você é consistente, não sortudo." },
          { type: "h", text: "Na prática" },
          { type: "p", text: "Se sua meta de lucro é US$ 3.000 e o limite da sua firm é 30%, nenhum dia pode ter lucrado mais que ≈ US$ 900. Se num dia você fez US$ 1.500, você 'travou' aquele dia e precisará de mais lucro total pra diluir aquele dia abaixo do limite." },
          ...
          { type: "tip", text: "O Analytics do MeuTrade mostra a distribuição de PnL por dia — use pra enxergar se algum dia está desproporcional ao restante." },
          { type: "key", text: "Regra de consistência: nenhum dia pode ser uma fatia grande demais do lucro total. Quando bater o limite do dia, pare. Confira o percentual exato da sua firm." },
        ],
      },
      {
        id: "5-5",
        ...
        duration: "7 min de leitura",
        blocks: [
          { type: "p", text: "Passar na avaliação não é sobre fazer muito dinheiro rápido — é sobre fazer pouco, de forma consistente, sem quebrar regra. Quem trata a avaliação como sprint reprova; quem trata como maratona passa." },
          ...
          { type: "list", items: [
            ...
            "Respeite a regra de consistência da sua firm: não faça um dia gigante.",
            "Opere só nos horários de maior probabilidade (abertura de NY).",
            "Use contratos menores (micros) pra controlar o risco com precisão.",
          ] },
          { type: "warn", text: "Não tente passar em 2 dias. Pressa = sizing grande = drawdown estourado. A maioria das avaliações não tem prazo curto justamente pra você ir devagar." },
          { type: "tip", text: "Combine: **Planner** (meta e limite do dia) + **Journal** (revisar execução) + **Analytics** (distribuição de resultados). Esse tripé é seu sistema de aprovação." },
      ...
      {
        id: "5-6",
        title: "Da avaliação à conta financiada (payout)",
        duration: "5 min de leitura",
        blocks: [
          { type: "p", text: "Passar na avaliação é o começo, não o fim. Agora você está numa conta **financiada**, operando capital da firma — e o objetivo vira sacar lucro (payout)." },
          { type: "h", text: "O que muda" },
          { type: "list", items: [
            "Continuam valendo o trailing drawdown e a disciplina — perder a conta financiada significa começar de novo.",
            "Há regras de **payout** (mínimo de dias, saldo mínimo, etc.) pra liberar seus saques — cada firm tem as suas.",
            "A consistência continua sendo rei: a firma quer um trader durável, não um apostador sortudo.",
          ] },
          { type: "warn", text: "Muita gente passa na avaliação e quebra a conta financiada na primeira semana por relaxar no risco. A conta financiada exige a MESMA disciplina — ou mais." },
          { type: "key", text: "Conta financiada = capital real da firma + objetivo de payout. As mesmas regras de risco continuam. Disciplina não tem fim de jogo." },
        ],
      },
    ],
  },
